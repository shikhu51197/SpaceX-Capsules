  ...
  return (
    <>
      <div>
        ...
        <div
          class="min-h-screen mt-10 bg-gray-100 py-6 flex flex-col justify-center sm:py-12  bg-cover"
          style={{
            backgroundImage:
              'url("https://images.unsplash.com/photo-1600303881706-b8a373dc73c3?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")',
